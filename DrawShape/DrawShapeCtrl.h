...
// ディスパッチ マップ
	...
	afx_msg LONG GetCurrentPenStyle();
	afx_msg void SetCurrentPenStyle(LONG newVal);
...
public:
	enum {
		...
		dispidClear = 22L,
		dispidRedraw = 21L,
		dispidCanMouseWheelZoom = 20,
		dispidCanMouseDragPan = 19,
		dispidCurrentBrushColor = 18,
		dispidCurrentPenStyle = 17,
